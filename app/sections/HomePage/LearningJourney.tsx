...
import "@/app/css/learning-journey.css";
      ...
      <div className="main-container learning-journey-container">
        <div className="learning-journey-content">
          ...
          <h4 className="learning-journey-description">
            ...
            , we are committed to making Quran learning accessible, interactive,
            and enriching for students of all ages. With expert tutors, flexible
            online classes, and a structured curriculum, we provide a seamless
            learning experience tailored to your needs. Whether you&apos;re
            starting your journey, improving Tajweed, or memorizing the Quran,
            our platform ensures high-quality education from the comfort of your
            home.
          </h4>
