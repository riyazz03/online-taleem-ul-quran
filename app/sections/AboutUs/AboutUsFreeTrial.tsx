...
import "@/app/css/about-us-free-trial.css";
        ...
        <div className="free-trial-content-block">
          <div className="free-trial-content">
            ...
            <p className="free-trial-description">
              Drop by to say Salaam and get the answers you seek in a welcoming
              space. Clear your doubts, gain clarity, and start your journey
              toward deeper faith today!
            </p>
